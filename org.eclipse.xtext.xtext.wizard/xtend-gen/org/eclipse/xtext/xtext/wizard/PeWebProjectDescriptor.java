...
public class PeWebProjectDescriptor extends ProjectDescriptor {
  ...
  public Set<ExternalDependency> getExternalDependencies() {
    ...
    ExternalDependency _createMavenDependency_1 = ExternalDependency.createMavenDependency(("org.webjars:requirejs:" + PeWebProjectDescriptor.REQUIREJS_VERSION));
    deps.add(_createMavenDependency_1);
    ExternalDependency _createMavenDependency_2 = ExternalDependency.createMavenDependency(("org.webjars:jquery:" + PeWebProjectDescriptor.JQUERY_VERSION));
    deps.add(_createMavenDependency_2);
    ExternalDependency _createMavenDependency_3 = ExternalDependency.createMavenDependency(("org.webjars:ace:" + PeWebProjectDescriptor.ACE_VERSION));
    deps.add(_createMavenDependency_3);
    ExternalDependency _createMavenDependency_4 = ExternalDependency.createMavenDependency(("org.eclipse.jetty:jetty-annotations:" + PeWebProjectDescriptor.JETTY_VERSION));
    ...
    ExternalDependency _createMavenDependency_5 = ExternalDependency.createMavenDependency(("org.slf4j:slf4j-simple:" + PeWebProjectDescriptor.SLF4J_VERSION));
  ...
  public PeWebProjectDescriptor(final WizardConfiguration config) {
    super(config);
  }
}
